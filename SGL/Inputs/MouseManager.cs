...
public sealed class MouseManager
{
	...
	public float MouseWheelValue => _curr.ScrollWheelValue / 120;
	...
	public bool IsButtonDown(byte button)
	{
		switch(button)
		{
			...
			case 3: return _curr.MiddleButton == ButtonState.Pressed;
			default: throw new ArgumentOutOfRangeException($"button {button} value not exist in MouseManager");
		}
	}
	...
	public bool IsButtonUp(byte button)
	{
		switch(button)
		{
			...
			case 3: return _curr.MiddleButton == ButtonState.Released;
			default: throw new ArgumentOutOfRangeException($"button {button} value not exist in MouseManager");
		}
	}
	...
	public bool WasButtonPressed(byte button)
	{
		switch(button)
		{
			...
			case 3: return _curr.MiddleButton == ButtonState.Pressed && _prev.MiddleButton == ButtonState.Released;
			default: throw new ArgumentOutOfRangeException($"button {button} value not exist in MouseManager");
		}
	}
	...
	public bool WasButtonReleased(byte button)
	{
		switch(button)
		{
			...
			case 3: return _curr.MiddleButton == ButtonState.Released && _prev.MiddleButton == ButtonState.Pressed;
			default: throw new ArgumentOutOfRangeException($"button {button} value not exist in MouseManager");
		}
	}
}
